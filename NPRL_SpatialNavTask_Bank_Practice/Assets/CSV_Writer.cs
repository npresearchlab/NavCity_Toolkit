...
public class CSV_Writer : MonoBehaviour
{
    ...
    // There are 710 columns in this CSV file that contain specific information about the participant and the session.
    ...
    private string getPath(){
        #if UNITY_EDITOR
        return Application.dataPath +"/CSV/"+"Saved_control_data_"+ ParticipantID + ".csv";
        #else
